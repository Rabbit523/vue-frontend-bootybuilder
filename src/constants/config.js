...
export const apiUrl = "https://api.appadmin.bootybuilder.com/api";
export const uploadUrl = "https://api.appadmin.bootybuilder.com/";

// export const apiUrl = "http://localhost:9090/api";
// export const uploadUrl = "http://localhost:9090/";
