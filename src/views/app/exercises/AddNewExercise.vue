<template>
  <div>
    <b-row>
      <b-colxx xxs="12">
        <piaf-breadcrumb :heading="$t('menu.add-new-exercise')" />
          ...
          <b-card class="mb-4" no-body>
            <b-card-body>
              ...
              <div :style="'position: relative;\
                      ...
                      background-size: cover;'">
                      <canvas ref="canvas" style="display: fixed; width: 100%; height: 100%; position: absolute;" width="336" height="189"></canvas>
...
export default {
  ...
  methods: {
    ...
    publish(is_published) {
      ...
      axios.post(apiUrl+'/add_exercises', formdata,
      {
        headers: {
  ...
  watch: {
    ...
    videoFile() {
      ...
      if(url != null) {
        this.videoPath = url;
        this.$refs.myPlayer.setSource([{ src: this.videoPath, type: 'video/mp4'}]);
