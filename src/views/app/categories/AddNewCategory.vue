<template>
  <div>
    <b-row>
      <b-colxx xxs="12">
        <piaf-breadcrumb :heading="$t('menu.add-new-category')" />
        ...
        <b-colxx xxs="12" md="12" xl="8" class="col-left">
          ...
          <b-card v-if="tags.length" class="mb-4" no-body>
            <b-tabs card no-fade v-model="tabIndex">
              <b-modal id="modalEditTab" ref="modalEditTab" title="Edit Tag">
                  <b-form-group label-cols="2" horizontal label="Tag Name">
                    <b-form-input v-model="editTag" placeholder="Tag Name"></b-form-input>
                  </b-form-group>
        ...
        <b-colxx xxs="12" md="12" xl="4" class="col-left">
          ...
          <b-card class="mb-4" no-body>
            <b-card-body>
              ...
              <b-file v-model="imgFile" class="mt-3 mr-1" accept="image/*"></b-file>
...
export default {
  ...
  methods: {
    ...
    publish(is_published) {
      ...
      axios.post(apiUrl+'/add_categories', formdata,
      {
        headers: {
